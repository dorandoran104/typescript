...
app.use('/admin', JWTMiddleware_1.JWTMiddleware.checkAdminToken, AdminHomeRoutes_1.default);
app.use('/admin/employee', JWTMiddleware_1.JWTMiddleware.checkAdminToken, AdminEmployeeRoutes_1.default);
app.use('/admin/category', JWTMiddleware_1.JWTMiddleware.checkAdminToken, AdminCategoryRoutes_1.default);
