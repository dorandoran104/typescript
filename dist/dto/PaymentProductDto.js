...
exports.PaymentProductDto = void 0;
class PaymentProductDto {
    constructor(paymentProduct) {
...
exports.PaymentProductDto = PaymentProductDto;
class PaymentProductBuilder {
    setIdx(idx) {
        this.idx = idx;
        return this;
    }
    setGoodsIdx(goods_idx) {
        this.goods_idx = goods_idx;
        return this;
    }
    setPaymentIdx(payment_idx) {
        this.payment_idx = payment_idx;
        return this;
    }
    setGoodsName(goods_name) {
